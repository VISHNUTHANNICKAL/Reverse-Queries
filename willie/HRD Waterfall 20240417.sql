...
,c.home_phone_number 'HOMEPHONE1'
...
--select * from #temp_home_phone where home_phone_number is not null loan_skey=239059 order by loan_skey
...
--select * from #temp_cell_phone where loan_skey=239059 order by loan_skey
...
IF OBJECT_ID('tempdb..#excludenumber') IS NOT NULL
    DROP TABLE #excludenumber;
select a.loan_skey,coalesce(a.[Home phone 1],'') 'PH1',coalesce(b.[Home phone 1],'') 'PH2',
coalesce(c.[Home phone 1],'') 'PH3' 
into #excludenumber
from (
select * from (
select loan_skey,sn,[Home phone 1],
ROW_NUMBER() over (partition by loan_skey order by loan_skey ) tn
 from(
select loan_skey,sn,[Home phone 1]
from #temp_home_phone
union 
select loan_skey,sn,[Cell Phone 1] from #temp_cell_phone
) a
) a where tn=1 )a 
left join (
select * from (
...
--select * from #excludenumber where loan_skey=267741
...
a.[MAILINGSTATE],
a.[MAILINGZIP],
case when a.LOANSKEY=b.loan_skey 
and a.[CONTACTTYPE1] in ('CoBorrower','Borrower') and (
 coalesce(a.[HOMEPHONE1],'')=b.PH1  
 OR  coalesce(a.[HOMEPHONE1],'')=b.PH2 
 or  coalesce(a.[HOMEPHONE1],'')=b.PH3 
 )
--and (  a.[CONTACTTYPE2] IN ('CoBorrower','Borrower') 
and coalesce(a.[HOMEPHONE2],'')=''
--or a.[CONTACTTYPE3] IN ('CoBorrower','Borrower')  and coalesce(a.[HOMEPHONE3],'')=''
--or a.[CONTACTTYPE4] IN ('CoBorrower','Borrower')  and coalesce(a.[HOMEPHONE4],'')='')
then coalesce(a.[HOMEPHONE1],'')  else  '' end as
[HOMEPHONE1],
case when a.LOANSKEY=b.loan_skey 
and a.[CONTACTTYPE1] in ('CoBorrower','Borrower') 
and (coalesce(a.[CELLPHONE1],'') =b.PH1 
OR coalesce(a.[CELLPHONE1],'') =b.PH2
or coalesce(a.[CELLPHONE1],'') =b.PH3 
)
--and ( a.[CONTACTTYPE2] IN ('CoBorrower','Borrower') 
and  coalesce(a.[CELLPHONE2],'')=''
--or a.[CONTACTTYPE3] IN ('CoBorrower','Borrower')  and coalesce(a.[CELLPHONE3],'')=''
--or a.[CONTACTTYPE4] IN ('CoBorrower','Borrower')  and coalesce(a.[CELLPHONE4],'')='')
then  coalesce(a.[CELLPHONE1],'')  else  '' end as 
--coalesce(a.[CELLPHONE1],'') 
[CELLPHONE1],
a.[default reason],
a.[CALLLIST],
a.[CONTACTTYPE2],
...
a.[CONTACTLASTNAME2],
/*case when a.LOANSKEY=b.loan_skey 
and a.[CONTACTTYPE2] in ('CoBorrower','Borrower') and (
 coalesce(a.[HOMEPHONE2],'')=b.PH1  
 OR  coalesce(a.[HOMEPHONE2],'')=b.PH2 
 or  coalesce(a.[HOMEPHONE2],'')=b.PH3 
 )
 and (a.[CONTACTTYPE3] IN ('CoBorrower','Borrower')  and coalesce(a.[HOMEPHONE3],'')=''
--or a.[CONTACTTYPE4] IN ('CoBorrower','Borrower')  and coalesce(a.[HOMEPHONE4],'')=''
)
then '' else
coalesce(a.[HOMEPHONE2],'') end as */
coalesce(a.[HOMEPHONE2],'') [HOMEPHONE2],
/*case when a.LOANSKEY=b.loan_skey 
and a.[CONTACTTYPE2] in ('CoBorrower','Borrower') 
and (coalesce(a.[CELLPHONE2],'') =b.PH1 
OR coalesce(a.[CELLPHONE2],'') =b.PH2
or coalesce(a.[CELLPHONE2],'') =b.PH3 
)
and (a.[CONTACTTYPE3] IN ('CoBorrower','Borrower')  and coalesce(a.[CELLPHONE3],'')=''
--or a.[CONTACTTYPE4] IN ('CoBorrower','Borrower')  and coalesce(a.[CELLPHONE4],'')=''
)
then '' else
coalesce(a.[CELLPHONE2],'')  end as */
coalesce(a.[CELLPHONE2],'')  [CELLPHONE2],
a.[CONTACTTYPE3],
a.[CONTACTFIRSTNAME3],
a.[CONTACTLASTNAME3],
/*case when a.LOANSKEY=b.loan_skey 
and a.[CONTACTTYPE3] in ('CoBorrower','Borrower') and (
coalesce(a.[HOMEPHONE3],'')=b.PH1  
 OR  coalesce(a.[HOMEPHONE3],'')=b.PH2 
 or  coalesce(a.[HOMEPHONE3],'')=b.PH3 
 )
 and (a.[CONTACTTYPE4] IN ('CoBorrower','Borrower')  and coalesce(a.[HOMEPHONE4],'')=''
)
then '' else 
coalesce(a.[HOMEPHONE3],'') end as*/
coalesce(a.[HOMEPHONE3],'') [HOMEPHONE3],
/*case when a.LOANSKEY=b.loan_skey 
and a.[CONTACTTYPE3] in ('CoBorrower','Borrower') and (
coalesce(a.[CELLPHONE3],'')=b.PH1  
 OR  coalesce(a.[CELLPHONE3],'')=b.PH2 
 or  coalesce(a.[CELLPHONE3],'')=b.PH3 
 )
 and (a.[CONTACTTYPE4] IN ('CoBorrower','Borrower')  and coalesce(a.[CELLPHONE4],'')=''
)
then '' else 
coalesce(a.[CELLPHONE3],'') end as */
...
coalesce(RTRIM(LTRIM(HOMEPHONE1)),'') HOMEPHONE1,
coalesce(case when RTRIM(LTRIM(CELLPHONE1))=RTRIM(LTRIM(HOMEPHONE1)) then '' else RTRIM(LTRIM(CELLPHONE1)) end,'') as CELLPHONE1
,[default reason],CALLLIST,CONTACTTYPE2,CONTACTFIRSTNAME2,CONTACTLASTNAME2,
coalesce(case when rtrim(ltrim(HOMEPHONE2))=RTRIM(LTRIM(HOMEPHONE1))
...
coalesce(case when rtrim(ltrim(CELLPHONE2))=RTRIM(LTRIM(HOMEPHONE1)) or
...
coalesce(case when rtrim(ltrim(HOMEPHONE3))=RTRIM(LTRIM(HOMEPHONE1))  or 
...
coalesce(case when rtrim(ltrim(CELLPHONE3))=(RTRIM(LTRIM(HOMEPHONE1))) or 
...
coalesce(case when rtrim(ltrim(HOMEPHONE4)) =(RTRIM(LTRIM(HOMEPHONE1))) or 
...
coalesce(case when rtrim(ltrim(CELLPHONE4))= (RTRIM(LTRIM(HOMEPHONE1))) or 
...
--into #finalDefault1
 from #finalDefault ) a
 left join #excludenumber b on a.LOANSKEY=b.loan_skey

 select * from #excludenumber order by  loan_skey;
 select * from #finalDefault1 where LOANSKEY in (select loan_skey from #excludenumber)
 order by LOANSKEY;
...
where LOANSKEY=239059 

(PROPERTYSTATE in ('WA','MA')
