...
a.[Mailing State],
a.[Mailing Zip],
case when a.[loan_skey]=b.loan_skey 
and a.[Contact Type1] in ('CoBorrower','Borrower') and (
 coalesce(a.[HOMEPHONE1],'')=b.PH1  
 OR  coalesce(a.[HOMEPHONE1],'')=b.PH2 
 or  coalesce(a.[HOMEPHONE1],'')=b.PH3 
 )
and (  a.[CONTACTTYPE2] IN ('CoBorrower','Borrower')  and coalesce(a.[HOMEPHONE2],'')=''
...
then '' else coalesce(a.[HOMEPHONE1],'')  end as HOMEPHONE1,
case when a.[loan_skey]=b.loan_skey 
and a.[Contact Type1] in ('CoBorrower','Borrower') 
and (coalesce(a.[CELLPHONE1],'') =b.PH1 
OR coalesce(a.[CELLPHONE1],'') =b.PH2
or coalesce(a.[CELLPHONE1],'') =b.PH3 
)
and ( a.[CONTACTTYPE2] IN ('CoBorrower','Borrower')  and  coalesce(a.[CELLPHONE2],'')=''
...
then '' else coalesce(a.[CELLPHONE1],'')  end as 
 CELLPHONE1,
--a.[Work Phone #],
a.[default reason],
a.[CALLLIST],
...
then '' else
coalesce(a.[HOMEPHONE2],'') end as HOMEPHONE2 ,
case when a.[loan_skey]=b.loan_skey 
...
then '' else
coalesce(a.[CELLPHONE2],'')  end as  CELLPHONE2,
a.[CONTACTTYPE3],
a.[CONTACTFIRSTNAME3],
a.[CONTACTLASTNAME3],
case when a.[loan_skey]=b.loan_skey 
...
then '' else 
coalesce(a.[HOMEPHONE3],'') end as HOMEPHONE3,
case when a.[loan_skey]=b.loan_skey 
and a.[CONTACTTYPE3] in ('CoBorrower','Borrower') and (
...
then '' else 
coalesce(a.[CELLPHONE3],'') end as CELLPHONE3,
a.[CONTACTTYPE4],
a.[CONTACTFIRSTNAME4],
a.[CONTACTLASTNAME4],
...
--into #finalDefault1
 from #finalDefault ) a 
  left join #excludenumber b on a.loan_skey=b.loan_skey
--where loan_skey=244696;

 select * from #excludenumber --where loan_skey=89286;
 select * from #finalDefault1 where loan_skey in (select loan_skey from #excludenumber);
