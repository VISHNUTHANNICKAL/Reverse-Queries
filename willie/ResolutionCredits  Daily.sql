...
--select * from #tempTbl where loan_skey = '277567' order by loan_skey;
...
--select * from #tempTbl where loan_skey = '277567'
...
row_number() over(partition by loan_skey order by created_date desc ) as rn
from [ReverseQuest].[rms].[v_Note] 
where note_type_description = 'Promise Tax & Ins Doc') as T where rn=1 /*and loan_skey in('277567',
'164856',
'221050',
'188739'
)*/
