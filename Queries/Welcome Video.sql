...
,rls.payment_method as 'Payment Method'
...
-- rls.created_date > Convert(datetime, '2022-02-28' )
 rls.created_date >= Convert(datetime, '2022-11-01' )
 and
	rls.created_date < Convert(datetime, '2022-11-30' )
 and 
 rls.loan_status_description = 'ACTIVE'
 and rls.loan_sub_status_description <> 'Pending Documents';
...
,case when (a.[Payment Method] is null or [Payment Method] = '') and b.loan_skey is not null then 'Check' else a.[Payment Method] end as 'Payment Method',
 --,a.[Payment Method],
...
where note_text like 'Level _ QC completed%' 
--and loan_skey= '326621'
)b on a.[Loan Skey]=b.loan_skey;

--select * from #tblTemp2 where loan_skey = '326659'
